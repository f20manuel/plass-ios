...
class PaymentProblemController extends GetxController {
  ...
  sendMessage() async {
    try {
      ...
      Firestore.generateLog(exception, 'line 21 in lib/help/account_problem/payment_problem/payment_problem_controller.dart');
    }
  }
}