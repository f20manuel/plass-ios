...
class PaymentProblemPage extends GetView<PaymentProblemController> {
  PaymentProblemPage({Key? key}) : super(key: key);
                  ...
                  child: Wrap(
                    children: const [
                      SingleChildScrollView(
                        ...
                        child: Text('Problema con el cobro',
                            style: TextStyle(
                              fontSize: 24,
          ...
          child: Padding(
            ...
            child: Column(children: [
              Container(
                ...
                child: const Text(
                  'Cuéntanos en una breve descripción que problema tuviste con el cobro.',
                ),
              ),
              Form(
                  key: formKey,
