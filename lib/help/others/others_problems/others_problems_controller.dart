...
class OthersProblemsController extends GetxController {
  ...
  sendMessage() async {
    try {
      ...
      Firestore.generateLog(exception, 'line 21 in lib/help/others/others_problems/others_problems_controller.dart');
    }
  }
}