...
import 'my_account_problem_controller.dart';

class MyAccountProblemPage extends GetView<MyAccountProblemController> {
  MyAccountProblemPage({Key? key}) : super(key: key);
                  ...
                  child: Wrap(
                    children: const [
                      SingleChildScrollView(
                        ...
                        child: Text('Problema con la cuenta',
                            style: TextStyle(
                              fontSize: 24,
