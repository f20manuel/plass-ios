...
class MyAccountProblemController extends GetxController {
  ...
  sendMessage() async {
    try {
      ...
      Firestore.generateLog(exception, 'line 21 in lib/help/account_problem/my_account_problem/my_account_problem_controller.dart');
    }
  }
}